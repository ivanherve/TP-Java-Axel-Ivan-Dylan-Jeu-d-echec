...
public class fou extends piece {
	...
	public fou(int xP, int yP, int idC ,int idP , int iddlP) {
		super(xP,  yP,  idC) ; 
		this.idpiece = idP ;
		this.nom = "fou" ;
    ...
    */
     ...
     * @return false lorsque le roi n'est pas menacé
     * @param x, y
     * @param ech1
     */
	public boolean simulationdepEchec(int x , int y , echiquier ech1){
		if (this.getxP()+ x > 7 || this.getxP() + x < 0 || this.getyP() + y  < 0 || this.getyP() + y  > 7 ) 
		  { return false ; } /* Pour pas qu'une piece sorte de l'échiquier */
		if (this.isEnVie() == false ) /*Pour que la pièce existe avant d'être éliminer*/
		  { return false ; }
