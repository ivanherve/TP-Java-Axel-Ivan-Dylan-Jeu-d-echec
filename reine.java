...
public class reine extends piece {
		...
		public reine(int xP, int yP, int idC ,int idP , int iddlP) {
			super(xP,  yP,  idC) ; 
			this.idpiece = idP ;
			this.nom = "reine" ;
     ...
     */
		public boolean metEnEchec(int x, int y , echiquier ech1){
			if (this.simulationdepEchec(x, y, ech1) == true){
				for(int i = 30 ; i <=31  ; i++ ){
    ...
    /*
     * Mise en situation d'echec,
     * @param x, y, ech1
     */    
    public boolean simulationdepEchec(int x , int y , echiquier ech1){
			...
			if (this.isEnVie() == false )
			  { return false ; }
			if(Math.abs(x) - Math.abs(y) != 0 && x*y != 0 )
			{return false ; }
			if(Math.abs(x) - Math.abs(y) == 0){
				if (x  > 0  && y > 0 ){
					for(int i = 0 ; i <=15  ; i++ ){
						  for(int j = 1 ; j<y ; j++){
					      if((ech1.pion[i][0].getxP() == this.getxP()+ j && ech1.pion[i][0].getyP() == (this.getyP()+j) && ech1.pion[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
					      }
					  }
					  for(int i = 16 ; i <=19  ; i++ ){
						  for(int j = 1 ; j<y ; j++){
						  if((ech1.fou[i][0].getxP() == this.getxP()+ j && ech1.fou[i][0].getyP() == (this.getyP()+j) && ech1.fou[i][0].isEnVie() ==  true )){
						      return false ; 
						   }
						  }
					   }
					  for(int i = 20 ; i <=23  ; i++ ){
						  for(int j = 1 ; j<y ; j++){
					      if((ech1.cavaliers[i][0].getxP() == this.getxP()+ j && ech1.cavaliers[i][0].getyP() == (this.getyP()+j) && ech1.cavaliers[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
					  for(int i = 24 ; i <=27  ; i++ ){
						  for(int j = 1 ; j<y ; j++){
					      if((ech1.tour[i][0].getxP() == this.getxP()+ j && ech1.tour[i][0].getyP() == (this.getyP()+j) && ech1.tour[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
					  for(int i = 28 ; i <=29  ; i++ ){
						  for(int j = 1 ; j<y ; j++){
					      if((ech1.reine[i][0].getxP() == this.getxP()+ j && ech1.reine[i][0].getyP() == (this.getyP()+j) && ech1.reine[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
					  for(int i = 30 ; i <=31  ; i++ ){
						  for(int j = 1 ; j<y ; j++){
					      if((ech1.roi[i][0].getxP() == this.getxP()+ j && ech1.roi[i][0].getyP() == (this.getyP()+j) && ech1.roi[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
				...
				if (x  > 0  && y < 0 ){
					for(int i = 0 ; i <=15  ; i++ ){
					  ...
					  for(int i = 28 ; i <=29  ; i++ ){
						  for(int j = 1 ; j<x ; j++){
					      if((ech1.reine[i][0].getxP() == this.getxP()+ x && ech1.reine[i][0].getyP() == (this.getyP()-j) && ech1.reine[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
					  for(int i = 30 ; i <=31  ; i++ ){
						  for(int j = 1 ; j<x ; j++){
					      if((ech1.roi[i][0].getxP() == this.getxP()+ x && ech1.roi[i][0].getyP() == (this.getyP()-j) && ech1.roi[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
			...
			if(x*y == 0 ){
				if(x == 0 && y > 1){
					  for(int i = 0 ; i <=15  ; i++ ){
						  for(int j = 1 ; j<y ; j++){
					      if((ech1.pion[i][0].getxP() == this.getxP()+ x && ech1.pion[i][0].getyP() == (this.getyP()+j) && ech1.pion[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
					      }
					  }
					  for(int i = 16 ; i <=19  ; i++ ){
						  for(int j = 1 ; j<y ; j++){
						  if((ech1.fou[i][0].getxP() == this.getxP()+ x && ech1.fou[i][0].getyP() == (this.getyP()+j) && ech1.fou[i][0].isEnVie() ==  true )){
						      return false ; 
						   }
						  }
					   }
					  for(int i = 20 ; i <=23  ; i++ ){
						  for(int j = 1 ; j<y ; j++){
					      if((ech1.cavaliers[i][0].getxP() == this.getxP()+ x && ech1.cavaliers[i][0].getyP() == (this.getyP()+j) && ech1.cavaliers[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
					  for(int i = 24 ; i <=27  ; i++ ){
						  for(int j = 1 ; j<y ; j++){
					      if((ech1.tour[i][0].getxP() == this.getxP()+ x && ech1.tour[i][0].getyP() == (this.getyP()+j) && ech1.tour[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
				...
				if(x < -1 && y == 0){
					  for(int i = 0 ; i <=15  ; i++ ){
						  for(int j = -1 ; j>x ; j--){
					      if((ech1.pion[i][0].getxP() == this.getxP()+ j && ech1.pion[i][0].getyP() == (this.getyP()+y) && ech1.pion[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
					      }
					  }
					  for(int i = 16 ; i <=19  ; i++ ){
						  for(int j = -1 ; j>x ; j--){
						  if((ech1.fou[i][0].getxP() == this.getxP()+ j && ech1.fou[i][0].getyP() == (this.getyP()+y) && ech1.fou[i][0].isEnVie() ==  true )){
						      return false ; 
						   }
						  }
					   }
					  for(int i = 20 ; i <=23  ; i++ ){
						  for(int j = -1 ; j>x ; j--){
					      if((ech1.cavaliers[i][0].getxP() == this.getxP()+ j && ech1.cavaliers[i][0].getyP() == (this.getyP()+y) && ech1.cavaliers[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
					  for(int i = 24 ; i <=27  ; i++ ){
						  for(int j = -1 ; j>x ; j--){
					      if((ech1.tour[i][0].getxP() == this.getxP()+ j && ech1.tour[i][0].getyP() == (this.getyP()+y) && ech1.tour[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
					  for(int i = 28 ; i <=29  ; i++ ){
						  for(int j = -1 ; j>x ; j--){
					      if((ech1.reine[i][0].getxP() == this.getxP()+ j && ech1.reine[i][0].getyP() == (this.getyP()+y) && ech1.reine[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }
					  for(int i = 30 ; i <=31  ; i++ ){
						  for(int j = -1 ; j>x ; j--){
					      if((ech1.roi[i][0].getxP() == this.getxP()+ j && ech1.roi[i][0].getyP() == (this.getyP()+y) && ech1.roi[i][0].isEnVie() ==  true )){
					         return false ; 
					      }				
						}
					  }	
